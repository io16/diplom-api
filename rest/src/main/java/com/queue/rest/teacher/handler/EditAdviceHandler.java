...
import com.queue.rest.teacher.request.EditAdviceRequest;
...
public class EditAdviceHandler implements Handler<RoutingContext> {
...
//              }
  ...
  private EditAdviceRequest parseRequest(String request) {
    return JSON.parseObject(request, EditAdviceRequest.class);
