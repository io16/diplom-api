...
--
-- Name: group_to_student; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.group_to_student (
    id integer NOT NULL,
...
ALTER SEQUENCE public.group_student_id_seq OWNED BY public.group_to_student.id;
...
--
-- Name: group_to_student id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_to_student ALTER COLUMN id SET DEFAULT nextval('public.group_student_id_seq'::regclass);
...
COPY public.advice (id, teacher_id, start_date, end_date, duration_per_student, type, description) FROM stdin;
1	1	2018-05-23 21:36:53.556	2018-05-23 21:36:58.524	0	1	\N
3	1	2018-05-24 16:48:01.425	2018-05-24 16:48:01.425	0	1	\N
\.
...
--
-- Data for Name: group_to_student; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.group_to_student (id, student_id, group_id) FROM stdin;
\.
...
1	dasdas	dsadsaaa111	222	asdasdas
\.
...
3	\N	1	2018-05-24 08:27:05.550129	\N	\N	\N	\N
1	1	1	2018-05-24 08:27:05.550129	2018-05-24 08:27:05.550129	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.advice_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.student_advice_id_seq', 4, true);
...
--
-- Name: group_to_student group_student_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_to_student
...
CREATE UNIQUE INDEX group_student_id_uindex ON public.group_to_student USING btree (id);
...
CREATE UNIQUE INDEX group_student_student_id_group_id_uindex ON public.group_to_student USING btree (student_id, group_id);
...
--
-- Name: group_to_student group_student_group_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: group_to_student group_student_student_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.student_advice
    ADD CONSTRAINT student_advice_advice_id_fk FOREIGN KEY (advice_id) REFERENCES public.advice(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.student_advice
    ADD CONSTRAINT student_advice_student_id_fk FOREIGN KEY (student_id) REFERENCES public.student(id) ON DELETE CASCADE;
